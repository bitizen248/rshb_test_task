...
import 'package:divan_test_task_rshb/screens/detailed_product_screen.dart';
    ...
    return GestureDetector(
      onTap: () {
        Navigator.of(context).push(MaterialPageRoute(
            builder: (c) => DetailedProductScreen(
                  product: product,
                )));
      },
      child: Container(
                  ...
                  Container(
                    ...
                    child: RichText(
                      ...
                      text: TextSpan(
                          ...
                          children: [
                            TextSpan(
                                text: " / ${product.unit}", style: TextStyle(fontSize: 12, color: RshbColors.grey96))
                          ]),
                    ),
                  ),
                  RatingBadge(
